...
class NestesEmbeddedWithAttachmentTest extends FixtureTestCase
{
    public function test_fixture(): void
    {
        ...
        $this->assertEquals("<HTML><HEAD></HEAD>\r\n<BODY dir=ltr>\r\n<DIV>Dear Sarah,</DIV>\r\n</BODY></HTML>", $message->getHTMLBody());
        ...
        $this->assertEquals('first.eml', $attachment->name);
        ...
        $this->assertInstanceOf(Attachment::class, $attachment);
        $this->assertEquals('second.eml', $attachment->name);
        $this->assertEquals('eml', $attachment->getExtension());
        $this->assertEquals('text', $attachment->type);
        $this->assertEquals('message/rfc822', $attachment->content_type);
        ...
        $this->assertEquals(631, $attachment->size);
